...
| 逆向工程        | 3   | protocol-reverse-engineering、reverse-engineering-android-malware-with-jadx、reverse-engineering-tools                                                                                                                         | 网络协议 / APK / 驱动反作弊（android-reverse-engineering 已修复待重启验证，见 [[#十、加载机制]]） |
